...
encrypt.setMaxDigits = function(value){
	maxDigits = value;
...
encrypt.RSAKeyPair = function(encryptionExponent, decryptionExponent, modulus)
{
...
encrypt.encryptedString = function(key, s)
